...
public final class CalculatorGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<sr.grpc.gen.MultiplicationArguments,
      sr.grpc.gen.ArithmeticOpResult> getMultiplyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Multiply",
      requestType = sr.grpc.gen.MultiplicationArguments.class,
      responseType = sr.grpc.gen.ArithmeticOpResult.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sr.grpc.gen.MultiplicationArguments,
      sr.grpc.gen.ArithmeticOpResult> getMultiplyMethod() {
    io.grpc.MethodDescriptor<sr.grpc.gen.MultiplicationArguments, sr.grpc.gen.ArithmeticOpResult> getMultiplyMethod;
    if ((getMultiplyMethod = CalculatorGrpc.getMultiplyMethod) == null) {
      synchronized (CalculatorGrpc.class) {
        if ((getMultiplyMethod = CalculatorGrpc.getMultiplyMethod) == null) {
          CalculatorGrpc.getMultiplyMethod = getMultiplyMethod =
              io.grpc.MethodDescriptor.<sr.grpc.gen.MultiplicationArguments, sr.grpc.gen.ArithmeticOpResult>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Multiply"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sr.grpc.gen.MultiplicationArguments.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sr.grpc.gen.ArithmeticOpResult.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void multiply(sr.grpc.gen.MultiplicationArguments request,
        io.grpc.stub.StreamObserver<sr.grpc.gen.ArithmeticOpResult> responseObserver) {
  ...
  public static final class CalculatorBlockingV2Stub
    ...
    /**
     */
    public sr.grpc.gen.ArithmeticOpResult multiply(sr.grpc.gen.MultiplicationArguments request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
  ...
  public static final class CalculatorBlockingStub
    ...
    /**
     */
    public sr.grpc.gen.ArithmeticOpResult multiply(sr.grpc.gen.MultiplicationArguments request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getMultiplyMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class CalculatorFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<sr.grpc.gen.ArithmeticOpResult> multiply(
        sr.grpc.gen.MultiplicationArguments request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_MULTIPLY:
          serviceImpl.multiply((sr.grpc.gen.MultiplicationArguments) request,
              (io.grpc.stub.StreamObserver<sr.grpc.gen.ArithmeticOpResult>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              sr.grpc.gen.MultiplicationArguments,
              sr.grpc.gen.ArithmeticOpResult>(
